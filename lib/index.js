...
module.exports = (strapi) => {
  ...
  const settingErrorLog = `${middlewareName} middleware configuration must contain a "settings" object. This object must contain at least the dsn property to initialise Sentry SDK. Check the config/environments/**/middleware.json file.`
